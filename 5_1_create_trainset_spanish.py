...
x_train, x_val, y_train, y_val = train_test_split(X_pre, Y_pre, test_size=0.1)

np.save(batches_path + '/' + 'x_val' + str(0) + '.npy', x_val)
np.save(batches_path + '/' + 'y_val' + str(0) + '.npy', y_val)


np.save(batches_path + '/' + 'x_train_' + str(0) + '.npy', x_train)
np.save(batches_path + '/' + 'y_train_' + str(0) + '.npy', y_train)
